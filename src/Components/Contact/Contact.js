...
const Contact = () => {
    return (
        <div className='input-container '>
            <h3 className="text-xl mt-52  text-yellow-500 font-bold text-center p-5">Contact Us</h3>
            ...
            <div className='input-info'>
                ...
                <button className='btn btn-warning rounded-xl mt-5 w-32 font-bold ml-24' type="submit">Submit</button>
            </div>
        </div>
    );
};
